...
def movies_view(request, profile_slug):
    ...
    if 'q' in request.GET and request.GET.get('q'):
        q = request.GET.get('q') #! ilim araması yapılınca hem Bilim kurgu kategoriden hem de Gerilim türünden olan aynı filmi 2 kez getiriyor!! ve küçük-büyük harf sorunlu
